...
public class DesiredGPAModel {
	...
	public void seeLetterArray(int [] upper, int [] lower,ArrayList <JTextField> classNameArray , ArrayList<JComboBox<String>> Credits, JTextField limitGPA, JTextField desiredGPA,  JTextField currentCuma,JTextField credTaken){
		includeArray.clear();
		cumaGPAArray.clear();
		semGPAArray.clear();
		classNames.clear();
		...
		combinations (boundLetterArray,boundLetterArray.size(),Credits,cLimitGPA,cDesiredGPA,cCurrentCuma,cCredTaken);
	...
	public void combinations(ArrayList<ArrayList <String>> boundedArrays, int size,ArrayList<JComboBox<String>> Credits,double limitGPA, double desiredGPA,  double currentCuma,int credTaken){
		if(size ==1){
	...
	private double calculateGPA(ArrayList <String> temp, ArrayList<JComboBox<String>> Credits,double limitGPA ,double cDesiredCuma,double cCurrentCuma,int cTotalCred){
