...
public class DesiredGPAView extends JFrame implements ActionListener, ItemListener{
	...
	public DesiredGPAView(){
		...
		/*
		 * adds Desired GPA label and a text field to the first panel that will be added to the JFrame
		 */
		...
		/*
		 * will be the second panel added to the JFrame
		 * adds current cumulative and total credits labels and their respected text fields.
		 */
		...
		/*
		 * third panel added
		 * creates a scrollable text field
		 */
		...
		spOutcomes = new JScrollPane(aOutcomes, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		
		/*
		 * fourth panel that will be added to the JFrame
		 * creates a scrollable panel that will update when the add class button is hit
		 */
		pClasses= new JPanel();
		...
		spClasses = new JScrollPane(pClasses,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		
		/*
		 * GUI will always at least have one class so it is a constant.
		 * following adds class name label, credits, Grade Known check box,
		 * upper bound, lower bound and their respective text fields ands 
		 * combo boxes.
		 */
		pClass1 = new JPanel ();
		...
		/*
		 * fifth panel that will be added to the Jframe
		 * creates the "add class" and "remove class" buttons
		 */
		...
		/*
		 * last constant panel to be added
        ...
        /*
         * puts together all constant panels created prior and gives properties to the window.
         */
